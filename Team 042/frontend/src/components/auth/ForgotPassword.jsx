    ...
    <div className="w-full flex">
      ...
      <div className="absolute right-0 h-screen  w-[35%] bg-gradient-to-t from-[#555554] via-[#171717] to-[#181919] flex items-center justify-center flex-col">
        <div className="w-[85%] flex flex-col justify-center items-start">
          ...
          <p className="text-white mb-5">Don't worry, happens to all of us. Enter your email below to recover your password</p>
          <form onSubmit={handleLogin} className="w-full">
            <div className="mb-4">
              ...
              <Input
                ...
                placeholder="Email"
                className="h-[44px] text-white border-none bg-gray-600"
                required
              />
            </div>
            <Button
          ...
          <div className="my-6 text-center flex items-center w-full">
          ...
          <div>
            <div className="flex flex-row w-full justify-between">
              <Button
                className="w-[30%] bg-gray-600 text-white font-bold py-2 px-4 rounded hover:bg-gray-100 border-none"
                type="button"
                variant="outline"
              >
                <span>Google</span>
